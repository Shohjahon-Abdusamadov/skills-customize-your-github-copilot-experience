...
Open the file `assignments/games-in-python/README.md` in VS Code and ask Copilot (Agent mode) to update it to follow the template. The instructions above will be applied automatically to Markdown files inside `assignments/` when editing.
